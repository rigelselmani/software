    ...
    return (
        <div>
           <div className="text-start design-header">
               ...
               <p className="p-header">Mobile & Web App UI/UX Experts</p>
                  ...
                  <div className="row g-0">
                    <div className="col-md-6">
                      <div className="card-body text-start">
                        ...
                        <p className="card-text text-secondary">In order to provide the best UI/UX design Services, Simpalm puts exceptional focus on UI design. We design rich and modern User Interfaces that smoothly work and show on all applicable screen sizes, resolutions, and iOS/Android platform iterations.</p>

...
export default function Footer (){
    return (
        ...
        <div className="col-lg-3 col-md-2 col-sm-4 mb-1"></div>
          <div className="col-lg-2 col-md-3 col-sm-4 mb-1">
              <div className="card-body text-start mt-4">
              <a className="navbar-brand text-primary fs-4 fst-italic " href="/"><span className="text-bg-dark m-0 rounded-3">Software</span> Services</a>
          ...
          <div className="col-lg-2 col-md-4 d-md-block d-none">
          ...
          <div className="col-lg-3 col-md-1 col-sm-4 mb-0"></div>
        </div>
    )
}